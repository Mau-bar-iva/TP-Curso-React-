        ...
        <section id="section-about" className='about-container'>
            ...
            <div className='about-features'>
                <div className='about-feature-item'>
                    <h4 className='feature-item-title'><img src="src/assets/category.svg" alt="" />Variety</h4>
                    <p className='feature-item-text'>Versatile Styles. Your Style, Your Rules. From Casual to Chic.</p>
                </div>
                <div className='about-feature-item'>
                    <h4 className='feature-item-title'><img src="src/assets/handshake.svg" alt="" />Customer proximity</h4>
                    <p className='feature-item-text'>Personalized Support. A Partnership in Style. Here for You.</p>
                </div>
                <div className='about-feature-item'>
                    <h4 className='feature-item-title'><img src="src/assets/delivery_truck.svg" alt="" />Fast Shipping</h4>
